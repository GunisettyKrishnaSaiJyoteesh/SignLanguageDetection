...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="Sign Language To Text Conversion Based On Hand Gesture Recognization(Multilingual Transalation)", font=("Courier", 20, "bold"))
        ...
        self.b2 = tk.Button(self.root,relief="flat", bg=self.root.cget("bg"), highlightthickness=0, activebackground=self.root.cget("bg"))
        self.b2.place(x=250, y=700)

        self.b3 = tk.Button(self.root,relief="flat", bg=self.root.cget("bg"), highlightthickness=0, activebackground=self.root.cget("bg"))
        ...
        self.translation_label.place(x=10, y=750+10)

        self.translation_output = tk.Label(self.root, text="", font=("Helvetica", 16))
        self.translation_output.place(x=140, y=750+10)

        #translation end part
        ...
        try:
            ...
            if hands:
                ...
                if handz:
                    ...
                    self.b1.config(text=self.word1, font=("Helvetica", 16), wraplength=825, command=self.action1)
    ...
    #translate & suggestion function api function
    ...
    def generate_suggestions(self,current_sentence, num_suggestions=4):
        ...
        return []
    #transalation and suggestion function end


    #remove function in sentence start

    def remove_char(self):
    # Remove the last character from the sentence if it's not empty
        if len(self.str) > 1:  # Ensure there's something to remove
            self.str = self.str[:-1]
        else:
            self.str = ""  # If the sentence is just a space, clear the string
